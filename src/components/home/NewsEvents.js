							...
							<div className="news-item">
								<Link to="/">
									<div
										...
										style={{ backgroundImage: `url(${SampleNews})` }}
									/>
								</Link>
								<div>
									<div className="pt-3">
											...
											<div className="col-9 pl-0">
												<Link to="/" className="text-body">
													<h5 className="font-weight-bold">
														LightFair 2018 - American Lighting Inc. &amp; Tivoli
														Lighting
													</h5>
												</Link>
												<div className="small text-primary text-uppercase d-block">
													<span>
														<i class="fa fa-user" /> American Lighting
													</span>
												</div>
											</div>
										</div>
									...
									<p className="text-muted pt-3">
										...
										LIGHTFAIR® International (LFI®) 2018 in one of this years
										premier events for the lighting industry.
									</p>
								</div>
							</div>
